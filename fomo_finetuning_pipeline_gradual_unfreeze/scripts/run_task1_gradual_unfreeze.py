...
def main():
    # Load configuration
    import os
    config_path = os.path.join(os.path.dirname(__file__), "..", "configs", "task1_gradual_unfreeze_config.json")
    ...
    pipeline = FOMOCrossValidationPipeline(task_id=1, config=config)
